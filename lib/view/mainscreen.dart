...
// import 'package:flutter/material.dart';
// import 'package:flutter_application_weather_app/controller/city_provider.dart';
...
//   SearchResultView({required this.controller});

//   @override
//   Widget build(BuildContext context) {
//     final model = Provider.of<SearchResultModel>(context);
...
//                 onPressed: () {
//                   // Handle reload action
//                   controller.fetchWeatherData('New York');
//                 },
//               ),
//             ),
//           ],
